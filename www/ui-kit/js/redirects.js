...
function redirect_about(){
    redirect('../about отдельный экран/about экран.html');
}
function redirect_error_call(){
    redirect('../error call/error_call.html');
}
...
function redirect_profile(){
    redirect("../../screens/Profile-main/profile-main.html");
}
function redirect_mail_confirmation(){
    redirect('../Mail confirmation/mailConfirmationInfo.html');
}
function redirect_login(){
    redirect('../loginka/loginka.html');
}
function redirect_geoposition(){
    redirect('../Geoposition/home.html');
}
